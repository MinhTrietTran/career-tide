...
BEGIN
	BEGIN
		SELECT apps.ApplicationID, a.ApplicantName AS Candidate_Name, v.Position AS Position, e.CompanyName AS Company_Name, apps.ApplicationStatus AS Result, apps.CoverLetter, apps.CV, apps.AcademicTranscript
